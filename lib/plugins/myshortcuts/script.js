...
// DokuWiki builds the toolbar via jQuery(function(){...}) (DOMContentLoaded).
// Core scripts are bundled before plugin scripts in the combined JS,
// so DokuWiki's initToolbar() jQuery-ready handler is registered first and
// runs before ours — guaranteeing the toolbar exists when we inject the mic button.
jQuery(function() {
